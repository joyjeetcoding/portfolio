      ...
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
        <div className='flex flex-col justify-center h-full '>
          ...
          <p className='text-gray-500 py-4 max-w-md'>
            I am an innovative <b>Frontend Developer</b>. I can create good <b>SEO-friendly</b> websites and have a good knowledge of <b>HTML</b>,<b>CSS</b> and <b>JAVASCRIPT</b> including framework like <b>Tailwind CSS</b> and libraries like <b>ReactJs</b>
          </p>
